...
const project = path.join.bind(path, process.cwd());
const src = path.join.bind(path, project(), "src");
const config = path.join.bind(path, project(), "config");
const dist = path.join.bind(path, project(), "dist");
const build = path.join.bind(path, project(), "build");
